  ...
  <div class="columns medium-5 large-4">
    ...
    <section class="apc-infopanel">
      ...
      <dl class="apc-paramlist">
        ...
        <dt class="apc-featlistitem">Ár (Ft)</dt>
        <?php if ( get_field('statusz') === 'free' ) : ?>
        <dd class="apc-featlistitem"><?= get_field('price') ?> M</dd>
        <?php else : ?>
        <dd class="apc-featlistitem"><?= stateinfo(get_field('statusz')) ?></dd>
        <?php endif; ?>
      </dl>
      <hr>
      <dl class="apc-paramlist">
      ...
      <div class="apc-infopanel__actions">
        <a class="button small" href="tel:+36307373444">Hívjon: + 36 30 7373 444</a>
        <?php if ( $file = get_field('csatolmany')) : ?>
        <a class="button small secondary nofancybox" href="<?= $file['url']  ?>">Alaprajz (PDF)</a>
        <?php endif; ?>
      </div>
    </section>
  </div>
